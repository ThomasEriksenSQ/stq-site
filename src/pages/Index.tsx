  ...
  return (
    <div className="relative min-h-screen bg-background flex flex-col justify-center px-8 md:px-16 lg:px-24">
      <div className="max-w-[1200px] space-y-10">
        ...
        <h1 className="text-[36px] md:text-[56px] font-bold leading-[1.05] tracking-[-0.02em] text-foreground max-w-3xl">
        ...
        <div className="pt-4">
          <button
            ...
            className="text-sm font-medium bg-foreground hover:bg-foreground/90 text-background px-4 py-2.5 rounded-md transition-all duration-150 h-[40px]"
          >
            Dette er STACQ
          </button>
        </div>

...
const MANIFEST = [
  ...
  },
  {
    ...
    text: "Vi er opptatt av gode holdninger – ryddige i arbeidet, tydelige i kommunikasjonen og gode å samarbeide med.",
  },
];
      ...
      >
        ...
        <div className="relative z-10 max-w-[1100px]">
          ...
          <p className="mt-7 text-[20px] text-muted-foreground leading-[2.0] max-w-[750px]">
            Vi har noen av Norges fremste spesialister på embedded systems, firmware og systemnær programvare.
          </p>
            ...
            {expandedConsultant !== null && (
              <>
                ...
                <motion.div
                  ...
                  className="fixed top-0 right-0 bottom-0 z-50 w-full md:w-[45%] md:min-w-[370px] bg-background border-l border-border overflow-y-auto"
                >
